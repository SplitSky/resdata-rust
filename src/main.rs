...
#[derive(Debug)]
struct Dataset {
    dictionaries: Vec<HashMap<String, String>>, // List of dictionaries
}
...
async fn main() -> std::io::Result<()> {
    ...
    ClientOptions::parse("mongodb+srv://splitsky:wombatcombat6@cluster0.xfvstgi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
      .await;
